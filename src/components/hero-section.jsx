...
export default function HeroSection() {
  return (
    <div className="relative mx-auto mb-8 overflow-hidden rounded-2xl bg-[#FFB5C7]">
      <div className="flex min-h-[300px] flex-col items-center justify-center p-6 md:min-h-[400px] md:p-8">
        {/* Vector Image - Left Side */}
        <div className="absolute left-0 top-1/2 hidden w-1/3 -translate-y-1/2 transform md:block">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-45TKtocs5PLIqdDQVskhHwz39TnMSd.png"
